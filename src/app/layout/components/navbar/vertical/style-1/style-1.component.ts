...
export class NavbarVerticalStyle1Component implements OnInit, OnDestroy
{
	...
	ngOnInit(): void
	{
		...
		if ( JSON.parse(localStorage.getItem('cadwolfUser')) === null )
		{
			this.displayType = 'noUser';
		}else
		{
        ...
        this.ProfileService.profileImageStatus
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((profileImage)=>{this.profileImage = profileImage;});
